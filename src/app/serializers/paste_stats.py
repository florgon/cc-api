...
def serialize_paste_stats(
    paste: PasteUrl,
    referer_views_value_as: str = "percent",
    dates_views_value_as: str = "percent",
) -> dict[str, Any]:
    """
    Serialize paste stats into response dictionary (json).
    :param PasteUrl paste: paste object
